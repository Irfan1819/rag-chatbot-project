...
RAG Document Q&A Chatbot — answers questions grounded in your own documents
Multi-Tool AI Agent — an AI agent that autonomously decides when to use tools like weather lookup, web search, a calculator, and date/time
...
For the RAG project: add .txt files to the documents/ folder
Run whichever project you want (see "Run it" sections above)
What I learned
